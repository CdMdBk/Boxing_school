...
$status_name = $bd->query("SELECT `name` FROM `statuses` WHERE `id` = '1'")->fetch_assoc()['name'];

$bd->query("INSERT INTO `applications` (`id`, `user_id`, `type_name`, `coach_name`, `time_name`, `status_name`) VALUES (NULL, '$user_id', '$type_name', '$coach_name', '$time_name', '$status_name')");
